export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to ASAI. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with ASAI on Slack, Discord, Telegram.',
  ...
  'channel.imessage.description':
    'Connect this assistant to iMessage through the local ASAI Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in ASAI Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and ASAI Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, ASAI Desktop receives local BlueBubbles webhooks and forwards them to ASAI.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to ASAI. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to ASAI. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to ASAI, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The ASAI Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between ASAI Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
