export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote ASAI server to enable data synchronization',
  ...
  'sync.ASAICloud.description': 'Officially provided cloud version',
  'sync.ASAICloud.title': 'ASAI Cloud',
