export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@ASAI.com</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@ASAI.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in ASAI',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the ASAI Community.',
  'footer.title': 'Share your creation on ASAI Community today',
  ...
  'models.providerInfo.apiTooltip': 'ASAI supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'ASAI Official Service',
  ...
  'skills.details.sidebar.platform.layout.ASAI': 'Skills are managed by ASAI automatically',
  ...
  'skills.details.sidebar.platform.steps.ASAI':
    'Install directly from the ASAI marketplace with one click.',
