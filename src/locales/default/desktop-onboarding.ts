export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using ASAI Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve ASAI. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve ASAI',
  ...
  'screen5.actions.signInCloud': 'Sign in to ASAI Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your ASAI Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'ASAI Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own ASAI server instance',
