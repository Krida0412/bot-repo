export default {
  ...
  'protocolInstall.official.badge': 'ASAI Official Skill',
  'protocolInstall.official.description': 'Official ASAI Skill, verified and security-checked.',
