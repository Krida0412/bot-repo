...
--
-- NOTE: This deployment uses the "default" tokenizer instead of "icu".
-- The pg_search build on the target Postgres (Prisma Postgres / pg_search 0.17.x)
-- is compiled without ICU support, so "icu" tokenizers crash the backend.
-- "default" works well for space-delimited languages (English, Indonesian, etc.).
-- If you migrate to a Postgres with ICU-enabled pg_search and need CJK tokenization,
-- switch these back to "icu".
...
WITH (
  ...
  text_fields = '{
    ...
    "description": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "slug":        {"tokenizer": {"type": "default"}},
    "system_role": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "user_id":     {"fast": true, "tokenizer": {"type": "keyword"}}
  }',
  json_fields = '{
    "tags": {"tokenizer": {"type": "default"}}
  }'
...
WITH (
  ...
  text_fields = '{
    ...
    "details":         {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
...
WITH (
  ...
  text_fields = '{
    "title":          {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "description":    {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "current_status": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
...
WITH (
  key_field = 'id',
  text_fields = '{
    "conclusion_directives": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "suggestions":           {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "type":                  {"fast": true, "tokenizer": {"type": "keyword"}},
    "user_id":               {"fast": true, "tokenizer": {"type": "keyword"}}
  }'
);--> statement-breakpoint
...
WITH (
  key_field = 'id',
  text_fields = '{
    "notes":     {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "narrative": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "feedback":  {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "type":      {"fast": true, "tokenizer": {"type": "keyword"}},
    "status":    {"fast": true, "tokenizer": {"type": "keyword"}},
    "user_id":   {"fast": true, "tokenizer": {"type": "keyword"}}
  }'
...
WITH (
  ...
  text_fields = '{
    "description":  {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "role":         {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "type":         {"fast": true, "tokenizer": {"type": "keyword"}},
...
WITH (
  key_field = 'id',
  text_fields = '{
    "situation":        {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "reasoning":        {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "possible_outcome": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "action":           {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "key_learning":     {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "type":             {"fast": true, "tokenizer": {"type": "keyword"}},
    "user_id":          {"fast": true, "tokenizer": {"type": "keyword"}}
  }'
);--> statement-breakpoint
...
WITH (
  key_field = 'id',
  text_fields = '{
    "tagline": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "persona": {"tokenizer": {"type": "default", "stemmer": "English", "stopwords_language": "English"}},
    "user_id": {"fast": true, "tokenizer": {"type": "keyword"}}
  }'
);--> statement-breakpoint
