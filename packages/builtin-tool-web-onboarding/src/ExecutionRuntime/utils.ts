...
const PHASE_GUIDANCE: Record<string, string> = {
  ...
  summary:
    "Phase: Summary. All structured fields and documents are in good shape. Present a natural summary of what you learned, send a warm closing message, and call `finishOnboarding`. Do NOT call `showAgentMarketplace`, `submitAgentPick`, `skipAgentPick`, or `cancelAgentPick` — the marketplace step is disabled in this deployment. Treat the user's text reply as the resolution signal and finish promptly.",
  user_identity:
