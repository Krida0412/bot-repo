...
export const OFFICIAL_URL = 'https://asai.app';
export const OFFICIAL_SITE = 'https://asai.app';
export const OFFICIAL_DOMAIN = 'asai.app';

export const OG_URL = '/og/og.webp?v=1';

export const GITHUB = 'https://github.com/Krida0412/bot-repo';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://asai.app/changelog';
...
export const FEEDBACK = 'https://github.com/Krida0412/bot-repo/issues/new/choose';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://chat-plugins.ASAI.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/ASAI/lobe-chat/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/ASAI/lobe-chat/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/ASAI/lobe-chat-agents';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');
export const AGENTS_OFFICIAL_URL = 'https://ASAI.com/agent';
...
export const BASE_PROVIDER_DOC_URL = 'https://asai.app/docs/usage/providers';
export const SITEMAP_BASE_URL = isDev ? '/sitemap.xml/' : 'sitemap';
export const CHANGELOG_URL = urlJoin(OFFICIAL_SITE, 'changelog');

export const DOWNLOAD_URL = {
  android: 'https://play.google.com/store/apps/details?id=com.ASAI.app',
