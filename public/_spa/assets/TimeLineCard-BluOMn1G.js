import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{qt as n}from"../i18n/i18n-zh-CN-CbR0_Rok.js";import{dt as r,pt as i}from"../vendor/vendor-data-runtime-Cn4-_Xzu.js";import{Js as a,Ws as o,cn as s,in as c,vl as l,yl as u}from"../vendor/vendor-ai-runtime-CsMkIwdb.js";import{Aa as d,Ba as f,Ia as p,Ma as m,Oa as ee,Wa as te,da as ne,za as h}from"./imperative-CZQgOWZc.js";import{Bs as re,Hs as ie,Is as g,L as ae,N as oe,Os as _,Rs as se,Vs as ce,Ws as le,ha as v,ir as ue,j as de,k as y,n as b,ws as fe,zs as pe}from"./es-na8XYpNF.js";import{Bm as me,Hc as he,Ig as ge,Jl as _e,Mi as ve,dt as x}from"../vendor/vendor-icons-BrLWQuP2.js";import{i as S,t as ye}from"./userMemory-BkGcl3P8.js";import{i as be,n as xe,t as Se}from"./dist-B6y5a0RZ.js";import{F as Ce,P as we}from"./index-CG_0atUX.js";import{n as Te,t as Ee}from"./useActivityTime-zuW7hM9w.js";import{r as De,t as Oe}from"./EditorModal-CzdlJxOj.js";import{n as ke,t as Ae}from"./NavHeader-Bz1hPApl.js";import{n as je,t as Me}from"./RightPanel-hDpASh85.js";import{n as Ne,t as Pe}from"./ToggleRightPanelButton-CJ30pz7o.js";import{n as Fe,r as Ie}from"./useScrollParent-ClX-q_BT.js";var Le,Re,ze,Be=t((()=>{Le=e(u()),De(),ye(),c(),Re=e(l()),ze=(0,Le.memo)(()=>{let e=S(e=>e.editingMemoryId),t=S(e=>e.editingMemoryContent),n=S(e=>e.editingMemoryLayer),r=S(e=>e.clearEditingMemory),i=S(e=>e.updateMemory),a={activity:s.Activity,context:s.Context,experience:s.Experience,identity:s.Identity,preference:s.Preference};return(0,Re.jsx)(Oe,{open:!!e,value:t,onCancel:r,onConfirm:async t=>{!e||!n||await i(e,t,a[n])}})})})),Ve,C,He,Ue=t((()=>{b(),x(),Ve=e(u()),r(),C=e(l()),He=(0,Ve.memo)(({searchValue:e,onSearch:t,sortValue:n,onSortChange:r,sortOptions:a})=>{let{t:o}=i(`memory`);return(0,C.jsxs)(d,{horizontal:!0,align:`center`,gap:12,children:[(0,C.jsx)(oe,{allowClear:!0,defaultValue:e,placeholder:o(`filter.search`),prefix:(0,C.jsx)(ve,{size:16}),style:{flex:1},onSearch:e=>t(e),onInputChange:e=>{e||t(e)}}),a&&a.length>0&&r&&(0,C.jsx)(de,{options:a,prefix:(0,C.jsx)(ne,{icon:ge,style:{marginRight:4}}),style:{minWidth:150},value:n,onChange:e=>r(e)})]})})})),We,w,Ge,T,E=t((()=>{b(),m(),We=e(u()),w=e(l()),Ge=p(({css:e,cssVar:t})=>({card:e`
    display: flex;
