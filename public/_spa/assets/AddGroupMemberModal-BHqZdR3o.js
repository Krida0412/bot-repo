import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{Ct as n,at as r,dt as i,ot as a,pt as o,wt as s}from"../vendor/vendor-data-runtime-Cn4-_Xzu.js";import{ks as c,vl as l,yl as u}from"../vendor/vendor-ai-runtime-CsMkIwdb.js";import{Aa as d,Ia as f,Ma as p}from"./imperative-CZQgOWZc.js";import{N as m,Os as h,Ua as g,cs as _,k as v,mr as y,n as b,os as x,to as S,us as C}from"./es-na8XYpNF.js";import{n as w,zt as T}from"./es-B2d2bv-I.js";import{dt as E,vt as D}from"../vendor/vendor-icons-BrLWQuP2.js";import{n as O,t as k}from"./agent-C2VhKPJI.js";import{r as A,t as ee}from"./dist-B6y5a0RZ.js";import{n as j,t as M}from"./AgentSelectionEmpty-PdL_i_Fo.js";var N,P=t((()=>{r(),N=a((e,t)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:e=>t().selectedAgentIds.includes(e),removeAgent:t=>{e(e=>({selectedAgentIds:e.selectedAgentIds.filter(e=>e!==t)}))},selectedAgentIds:[],setSelectedAgents:t=>{e({selectedAgentIds:t})},toggleAgent:t=>{e(e=>e.selectedAgentIds.includes(t)?{selectedAgentIds:e.selectedAgentIds.filter(e=>e!==t)}:{selectedAgentIds:[...e.selectedAgentIds,t]})}}))})),F,I,L,R,z=t((()=>{b(),g(),p(),E(),F=e(u()),c(),P(),I=e(l()),L=f(({css:e,cssVar:t})=>({item:e`
    cursor: pointer;
