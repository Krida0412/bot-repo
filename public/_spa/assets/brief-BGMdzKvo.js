import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{Q as n,X as r,Y as i,Z as a,dt as o,et as s,it as c,pt as l}from"../vendor/vendor-data-runtime-Cn4-_Xzu.js";import{Fs as u,vl as ee,yl as d}from"../vendor/vendor-ai-runtime-CsMkIwdb.js";import{_ as te,f as ne,g as re,h as ie,l as f,m as ae,p,t as m}from"./swr-CpnM5dDc.js";import{Aa as oe,Ia as h,Ma as g}from"./imperative-CZQgOWZc.js";import{F as _,L as v,Ua as y,cs as se,n as ce,qa as le}from"./es-na8XYpNF.js";import{dt as ue,nm as de,om as fe}from"../vendor/vendor-icons-BrLWQuP2.js";import{t as pe}from"./fast-deep-equal-MG-n9E1a.js";import{Cn as me,wn as he}from"./agent-h7g64c0D.js";import{n as ge,o as b}from"./client-cV4dDi-k.js";import{Et as x,G as S,Mn as C,W as w,pn as T,tn as E}from"./store-CDuzlPGA.js";import{a as D,i as O}from"./EditorCanvas-Ck8VEUPN.js";var k,A,j,M,N=t((()=>{x(),D(),k=e=>{if(!e)return[];let{imageList:t,fileList:n}=C(e),r=new Set;for(let{url:e}of t){let t=O(e);t&&r.add(t)}for(let{url:e}of n){let t=O(e);t&&r.add(t)}return[...r]},A=e=>e?.getLexicalEditor?.()?k(e.getDocument?.(`json`)):[],j=(e,t)=>{if(!e||t.length===0)return;let n=e.getLexicalEditor?.();if(n){for(let e of t)e.type.startsWith(`image/`)?n.dispatchCommand(E,{file:e}):n.dispatchCommand(T,{file:e});e.focus?.()}},M=(e,t)=>{if(!e?.getLexicalEditor?.())return;let n=document.createElement(`input`);n.type=`file`,n.multiple=!0,t&&(n.accept=t),n.addEventListener(`change`,()=>{j(e,Array.from(n.files??[]))}),n.click()}})),P,F=t((()=>{g(),P=h(({css:e,cssVar:t})=>({titleInput:e`
    &.ant-input {
      resize: none;
