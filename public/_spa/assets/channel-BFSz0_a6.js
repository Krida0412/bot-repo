import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{dt as n,mt as r,pt as i}from"../vendor/vendor-data-runtime-WZJuOlea.js";import{Fs as a,Rr as o,vl as s,yl as c}from"../vendor/vendor-ai-runtime-uGyLq_TW.js";import{r as l,t as u}from"./swr-CK7jF4RD.js";import{Aa as d,Ba as f,Ia as p,Ma as m,Wa as h,da as g}from"./imperative-Xfjd337A.js";import{Os as _,Ti as v,Wr as y,Yr as ee,br as b,gr as x,ha as S,n as C,qr as w,vr as te,vs as T,ws as E}from"./es-2ZVhpwv7.js";import{$ as D,Cn as O,Ft as k,U as ne,Y as re,_t as A,an as j,at as ie,j as ae,kn as oe,n as M,qn as se,s as N,xt as P}from"./es-DMB7XTXN.js";import{h as ce,m as le,n as ue}from"../vendor/vendor-react-D1dBs3e7.js";import{Bi as de,Jd as fe,Ji as pe,Xt as me,ba as he,bn as ge,cf as _e,dt as F,gh as ve,ma as ye,na as be,nf as xe,vt as Se}from"../vendor/vendor-icons-BvZ3Gdzv.js";import{n as Ce,s as we}from"./base-ui-CG2gzEWh.js";import{Gt as Te,Ut as Ee,Wt as De,Xt as Oe,en as ke,i as I,in as Ae,t as je}from"./agent-BV7ChU6o.js";import{l as Me,t as Ne}from"./client-B94qgQSx.js";import{n as Pe,t as Fe}from"./ipc-VJ9eOZba.js";import{d as Ie,r as Le,t as Re}from"./global-D_2Rs4fY.js";import{d as ze,u as Be}from"./electron-BTFW9gEx.js";import{t as Ve}from"./selectors-BaC4ALp4.js";import{K as He,q as Ue}from"./index-AVlnZl7f.js";import{n as We,t as Ge}from"./es-DJm_qhBI.js";import{n as Ke,t as qe}from"./InfoTooltip-DZMYdJKK.js";import{i as Je,o as Ye,t as Xe}from"./FormInput-dnD4EbcL.js";import{n as Ze,t as Qe}from"./useAppOrigin-VA6rKAbC.js";import{n as $e,r as et,t as tt}from"./const-cAmFsOz4.js";import{n as nt,t as rt}from"./NavHeader-CNur_1ZZ.js";var L,it=t((()=>{L={connected:`connected`,disconnected:`disconnected`,dormant:`dormant`,failed:`failed`,queued:`queued`,starting:`starting`}})),at,ot,st=t((()=>{Pe(),at=class{getStatus=async()=>Fe().imessageBridge.getStatus();removeConfig=async e=>Fe().imessageBridge.removeConfig({applicationId:e});start=async()=>Fe().imessageBridge.start();stop=async()=>Fe().imessageBridge.stop();testConfig=async e=>Fe().imessageBridge.testConfig(e);upsertConfig=async e=>Fe().imessageBridge.upsertConfig(e)},ot=new at})),ct,lt,ut=t((()=>{ct=e(c()),lt=(0,ct.createContext)(null)})),R,dt,ft=t((()=>{o(),C(),M(),m(),F(),R=e(c()),n(),Xe(),u(),ze(),st(),ut(),s(),p(({css:e,cssVar:t})=>({card:e`
    margin-block: 8px;
    padding: 20px;
