import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{qt as n}from"../i18n/i18n-zh-CN-CbR0_Rok.js";import{at as r,dt as i,ot as a,pt as o}from"../vendor/vendor-data-runtime-WZJuOlea.js";import{Et as s,_l as c,gl as l,li as u,pi as d,ui as f,vl as p,vt as m,wt as h,yl as g}from"../vendor/vendor-ai-runtime-uGyLq_TW.js";import{Aa as _,Ia as v,J as y,Ma as b,Ua as x,Wa as S,da as C,za as w}from"./imperative-Xfjd337A.js";import{Is as T,Na as ee,Os as E,Xn as D,cs as O,ha as te,k as ne,n as k,os as A,ws as j}from"./es-2ZVhpwv7.js";import{kn as re,n as ie,sn as ae}from"./es-DMB7XTXN.js";import{a as oe,m as M,n as N}from"../vendor/vendor-react-D1dBs3e7.js";import{Bc as se,Et as ce,Mi as le,Wg as ue,Wn as de,Wp as fe,Wu as pe,bn as me,cr as he,cs as ge,dt as P,gt as _e,mm as F,nc as ve,nf as ye,oc as be,os as xe,um as Se,vt as Ce,ws as we}from"../vendor/vendor-icons-BvZ3Gdzv.js";import{n as Te,s as Ee}from"./base-ui-CG2gzEWh.js";import{a as De,f as Oe,i as ke,m as Ae,t as je}from"./agent-BV7ChU6o.js";import{c as Me,i as Ne,l as Pe,s as Fe,t as Ie}from"./selectors-DBjKY9xR.js";import{Cr as Le,Sr as Re,Ui as ze,n as I}from"./store-DTt7Ili4.js";import{K as Be,q as Ve}from"./index-AVlnZl7f.js";import{b as He,x as Ue}from"./ChatInput-CJIgjgUI.js";import{n as We,t as Ge}from"./useActivityTime-DwaVDXbp.js";import{n as Ke,t as qe}from"./NavHeader-CNur_1ZZ.js";import{n as Je,t as Ye}from"./useDropdownMenu-BOSyD90h.js";var Xe,L,R=t((()=>{r(),Xe={groupBy:`byTime`,groupIds:[],search:``,selectMode:!1,selectedIds:[],sortBy:`updatedAt`,status:`active`,timeRange:`all`,triggers:[`chat`],viewMode:`card`},L=a(e=>({...Xe,clearSelected:()=>e({selectedIds:[]}),exitSelectMode:()=>e({selectMode:!1,selectedIds:[]}),reset:()=>e(Xe),selectAll:t=>e({selectedIds:t}),setGroupBy:t=>e({groupBy:t}),setGroupIds:t=>e({groupIds:t}),setSearch:t=>e({search:t}),setSortBy:t=>e({sortBy:t}),setStatus:t=>e({status:t}),setTimeRange:t=>e({timeRange:t}),setTriggers:t=>e({triggers:t}),setViewMode:t=>e({viewMode:t}),toggleSelectMode:()=>e(e=>({selectMode:!e.selectMode,selectedIds:e.selectMode?[]:e.selectedIds})),toggleSelected:t=>e(e=>({selectedIds:e.selectedIds.includes(t)?e.selectedIds.filter(e=>e!==t):[...e.selectedIds,t]}))}))})),Ze,z,Qe,$e,et=t((()=>{k(),Te(),b(),P(),Ze=e(g()),i(),ze(),R(),z=e(p()),Qe=v(({css:e})=>({bar:e`
    pointer-events: auto;
