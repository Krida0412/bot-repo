import{a as e,n as t}from"./rolldown-runtime-Cyuzqnbw.js";import{dt as n,pt as r}from"../vendor/vendor-data-runtime-WZJuOlea.js";import{Et as i,Ua as a,_l as o,gl as s,gt as c,na as l,sa as u,vl as d,yl as f}from"../vendor/vendor-ai-runtime-uGyLq_TW.js";import{Aa as p,Ba as m,Ia as h,J as g,Ma as _,Oa as v,Ua as y,cn as ee,da as b,dn as x,ln as te,za as S}from"./imperative-Xfjd337A.js";import{Er as ne,Fr as re,Is as ie,N as ae,Os as C,cs as oe,ha as w,ir as T,k as se,mr as ce,n as E,us as le,ws as ue}from"./es-2ZVhpwv7.js";import{_t as de,an as fe,ct as pe,kn as me,lt as he,n as D}from"./es-DMB7XTXN.js";import{a as ge,h as _e,m as ve,n as ye}from"../vendor/vendor-react-D1dBs3e7.js";import{Bt as be,Jd as xe,Kd as Se,Ra as Ce,Su as we,Wd as Te,Wf as Ee,ba as De,bd as Oe,cf as ke,cr as Ae,dt as je,if as Me,mn as Ne,op as Pe,vu as Fe}from"../vendor/vendor-icons-BvZ3Gdzv.js";import{n as Ie,r as Le,s as Re}from"./base-ui-CG2gzEWh.js";import{Bt as ze,i as Be,t as Ve,zt as He}from"./agent-BV7ChU6o.js";import{n as Ue,o as We}from"./client-C0dgA5Xe.js";import{n as Ge,t as Ke}from"./agent-BUstbF8o.js";import{Ar as qe,N as Je,Or as Ye,P as O}from"./store-DTt7Ili4.js";import{n as Xe,t as Ze}from"./discover-CXHrW0C-.js";import{p as Qe,s as $e,t as et}from"./serverConfig-BWsHRSvm.js";import{n as tt,t as nt}from"./PublishedTime-z4JfztEW.js";import{i as rt,o as it,t as at}from"./MarketAuth-DqgKrG7q.js";import{a as ot,i as st,r as ct,t as lt}from"./discover-duTVUZN7.js";import{n as ut,t as dt}from"./NotFound-DhcedyLb.js";import{n as ft,t as pt}from"./AssistantEmpty-CBkr5eSL.js";import{n as mt,r as ht}from"./ListLoading-BF9xt25D.js";var gt,_t,vt,yt,k,A=t((()=>{gt=e(f()),_t=e(d()),vt=(0,gt.createContext)(null),yt=(0,gt.memo)(({children:e,config:t})=>(0,_t.jsx)(vt,{value:t,children:e})),k=()=>{let e=(0,gt.use)(vt);if(!e)throw Error(`useUserDetailContext must be used within UserDetailProvider`);return e}})),bt,xt,St,Ct=t((()=>{E(),bt=e(f()),n(),at(),st(),lt(),xt=e(d()),St=(0,bt.memo)(({userId:e})=>{let{t}=r(`discover`),{isAuthenticated:n,signIn:i,session:a}=rt(),[o,s]=(0,bt.useState)(!1),c=ct(e=>e.useFollowStatus),l=ct(e=>e.follow),u=ct(e=>e.unfollow);a?.accessToken&&ot.setAccessToken(a.accessToken);let{data:d,mutate:f}=c(e),p=d?.isFollowing??!1;return(0,xt.jsx)(oe,{loading:o,shape:`round`,size:`large`,type:p?`default`:`primary`,style:{fontWeight:500,minWidth:120},onClick:async()=>{if(!n){await i();return}s(!0);try{p?await u(e):await l(e),await f()}catch(e){console.error(`Follow action failed:`,e)}finally{s(!1)}},children:t(p?`user.unfollow`:`user.follow`)})})})),wt,j,Tt,Et=t((()=>{E(),wt=e(f()),n(),A(),j=e(d()),Tt=(0,wt.memo)(()=>{let{t:e}=r(`discover`),{user:t}=k(),n=t.followingCount??0,i=t.followersCount??0;return(0,j.jsxs)(p,{horizontal:!0,align:`center`,gap:16,children:[(0,j.jsxs)(p,{horizontal:!0,align:`center`,gap:8,children:[(0,j.jsx)(C,{style:{fontWeight:600},children:n}),(0,j.jsx)(C,{type:`secondary`,children:e(`user.following`)})]}),(0,j.jsxs)(p,{horizontal:!0,align:`center`,gap:8,children:[(0,j.jsx)(C,{style:{fontWeight:600},children:i}),(0,j.jsx)(C,{type:`secondary`,children:e(`user.followers`)})]})]})})})),Dt,M,Ot,kt,At=t((()=>{E(),_(),Dt=e(f()),M=e(d()),Ot=h(({css:e,cssVar:t})=>({banner:e`
    position: absolute;
    inset-block-start: 0;
